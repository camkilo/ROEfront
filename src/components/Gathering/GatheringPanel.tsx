...
export default function GatheringPanel({ player }: Props) {
  ...
  return (
    <div className="bg-gray-900 border border-indigo-600 rounded-md p-4 shadow-md max-w-md mx-auto my-6">
      ...
      <label className="block mb-2 font-semibold text-gray-300" htmlFor="biome-select">
        Select Biome:
      </label>
      <select
        id="biome-select"
